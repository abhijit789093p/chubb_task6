    ...
    btn.addEventListener("click", () => {
      let n = 1;
      let m = funt(n)
      // let res = JSON.stringify(m);
          t3.innerHTML= m;      
      }
  );

  let btn1 = document.createElement("button");
  btn1.setAttribute("id", "btnReadValue");
  btn1.textContent = "2";
...
btn2.setAttribute("id", "btnReadValue");
btn2.textContent = "3";
...
btn3.setAttribute("id", "btnReadValue");
btn3.textContent = "4";
...
btn4.setAttribute("id", "btnReadValue");
btn4.textContent = "5";
...
btn5.setAttribute("id", "btnReadValue");
btn5.textContent = "6";
...
btn6.setAttribute("id", "btnReadValue");
btn6.textContent = "7";
...
btn7.setAttribute("id", "btnReadValue");
btn7.textContent = "8";
...
btn8.setAttribute("id", "btnReadValue");
btn8.textContent = "9";
...
btn9.setAttribute("id", "btnReadValue");
btn9.textContent = "10";
...
pre.setAttribute("id", "btnReadValue");
...
nxt.setAttribute("id", "btnReadValue");
